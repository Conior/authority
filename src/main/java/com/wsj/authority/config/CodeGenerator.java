...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setDbType(DbType.MYSQL)
                .setUrl("jdbc:mysql://127.0.0.1:3306/bilibili?useUnicode=true&characterEncoding=UTF-8&serverTimezone=GMT")
        ...
        pc.setParent("com.wsj.authority")//配置父包路径
//                .setModuleName("base")//配置业务包路径
        ...
        strategy.setNaming(NamingStrategy.underline_to_camel)//设置命名规则  underline_to_camel 底线变驼峰
                ...
                .setInclude("role","user","user_role")//设置表名
